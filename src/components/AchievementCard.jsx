...
const AchievementCard = ({ achievement, dark }) => {
    ...
    return (
        <div className={`${dark ? 'bg-slate-900 shadow-stone-600' : 'bg-slate-300 '} h-max shadow-lg md:ml-4   w-full pt-10 pb-8 px-6 cursor-pointer rounded-2xl hover:scale-95 transition-all duration-300`}>
